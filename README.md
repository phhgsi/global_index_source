...
```
curl -s https://raw.githubusercontent.com/phhgsi/global_index_source/master/setup | bash
```
### For Linux/macOS/BSD systems (ROOT USER).
```
curl -s https://raw.githubusercontent.com/phhgsi/global_index_source/master/setup-root | bash
```
